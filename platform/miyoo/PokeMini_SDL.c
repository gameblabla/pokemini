...
void handleevents(SDL_Event *event)
{
	...
	case SDL_KEYDOWN:
		...
		} else if (event->key.keysym.sym == SDLK_LALT) {	// Dingoo A
			JoystickButtonsEvent(6, 1);
		} else if (event->key.keysym.sym == SDLK_LCTRL) {	// Dingoo B
			JoystickButtonsEvent(7, 1);
		} else if (event->key.keysym.sym == SDLK_SPACE) {	// Dingoo Y
			JoystickButtonsEvent(8, 1);
		} else if (event->key.keysym.sym == SDLK_LSHIFT) {	// Dingoo X
			JoystickButtonsEvent(9, 1);
		} else if (event->key.keysym.sym == SDLK_TAB) {		// Dingoo L1
			JoystickButtonsEvent(10, 1);
		} else if (event->key.keysym.sym == SDLK_BACKSPACE) {	// Dingoo R1
			JoystickButtonsEvent(11, 1);
			} else if (event->key.keysym.sym == SDLK_RCTRL) {	// Dingoo R
